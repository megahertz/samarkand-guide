...
export default {
  ...
  items: [
    ...
    },
    {
      ...
      tags: ['bar'],
      description:
        'Место с уютной верандой. Отличное обслуживание и неплохая ' +
        'кухня. Вечером здесь тихо. Очень удобно собираться компанией, когда ' +
        'заранее неизвестно количество участников.',
    },
    {

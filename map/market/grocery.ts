      ...
      items: [
        {
          ...
          description: 'Основной магазин неподалеку от Железнодорожного парка.',
        },
        {
          label: 'Kiwi — второй филиал',
          location: [39.636741, 66.975029],
          yandexMap: 'https://yandex.uz/maps/org/237818527499/',
          twoGis:
            'https://2gis.uz/samarkand/branches/70000001076640118/firm/70000001089368746',
          openHours: [{ time: 'круглосуточно' }],
          description: 'Филиал на улице Намазгох',
        },
      ],
    },
    {

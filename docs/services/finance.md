...
Также, карты нерезидентам делают в Алокабанк, Anorbank, Asia Alliance, InfinBANK,
Ипак Йули. При трудоустройстве вариантов становится больше.
...
принимает зарубежные карты (кроме российских), но некоторые отказываются.
Снять доллары с зарубежной карты можно только в кассах некоторых банков.
Выдают с карт VISA: Agrobank, Hamkor, Капиталбанк. Выдают с Mastercard:
Turonbank. Не выдают с зарубежных карт: Ziraat, OFB. Остальные банки надо
пробовать.

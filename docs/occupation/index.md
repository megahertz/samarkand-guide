...
Информация про самозанятость для нерезидентов противоречивая и постоянно
меняется. На начало 2023 года многие отписались, что успешно зарегистрировались
...
Самозанятые могут, в том числе, работать с иностранными клиентами и получать
платежи в валюте. Заявляют, что никакой отчетности не нужно. Статус самозанятого

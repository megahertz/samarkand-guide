...
export const products: Product[] = [
  {
    ...
    description:
      'Мощный беспроводной пылесос со сменным аккумулятором и тремя насадками. ' +
      'Мощность двигателя - 400Вт, всасывания - 120аВт . Время работы: ' +
      '60/27/8 мин.',
  },
  {
    id: 3,
  ...
  },
  {
    ...
    description:
      'Большой набор инструментов для дома - включает молоток, ' +
      'плоскогубцы, наборы отверток, мультиметр DT-9205A, паяльник с припоем ' +
      'и флюсами, ножовка, изоленты, крепежные элементы, ножи, клеи, смазки  ' +
      'и многое другое.',
  },
  {
    id: 20,
